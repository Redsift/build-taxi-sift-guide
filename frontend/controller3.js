...
Sift.Controller.loadView = function (value, resolve, reject) {
    ...
    //else if (value.type === 'summary' | 'email-detail' | 'compose') {
    else {
...
function loadTextView(sizeClass, resolve, reject) {
    ...
    Sift.Storage.get(
        {
            ...
            resolve({html: 'frontend/view3.html', label: 'Taxi Sift', data: {sizeClass: sizeClass, chart: chart}});
        }, function (error) {
    ...
    Sift.Storage.get(
        {
            ...
            resolve({html: 'frontend/view3.html', label: 'Taxi Sift', data: {sizeClass: sizeClass, chart: chart, table: table}});
        }, function (error) {
