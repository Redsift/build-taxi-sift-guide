...
function loadCompactSummaryView(sizeClass, resolve, reject) {
  ...
  Sift.Storage.get({
      ...
      resolve({html: 'frontend/view3.html', data: {sizeClass: sizeClass, chart: chart}});
    }, function (error) {
...
function loadFullSummaryView(sizeClass, resolve, reject) {
  ...
  Sift.Storage.get({
      ...
      resolve({html: 'frontend/view3.html', data: {sizeClass: sizeClass, chart: chart, table: table}});
    }, function (error) {
